            ...
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="card-title text-2xl">Edit Lokasi</h2>
                        <a href="{{ route('admin.lokasi.index') }}" class="btn btn-ghost btn-sm">← Kembali</a>
                    </div>

                    <!-- Form -->
                    <form action="{{ route('admin.lokasi.update', $lokasi->id) }}" method="POST" class="space-y-4">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-control">
                            ...
                            <textarea 
                                ...
                                placeholder="Masukkan deskripsi lokasi (opsional)">{{ old('deskripsi', $lokasi->deskripsi) }}</textarea>
                        </div>
